...
int main(int argc, char* argv[])
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		cube_shader.set_vec3("light.ambient", light_color * glm::vec3(0.2f));
		cube_shader.set_vec3("light.diffuse", light_color * glm::vec3(0.5f));
		cube_shader.set_vec3("light.specular", glm::vec3(1.0f)); // specular should always be white light
