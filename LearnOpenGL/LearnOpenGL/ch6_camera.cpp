...
// static void mouse_input(GLFWwindow* window, double x_pos_in, double y_pos_in);
...
// }
//
// void mouse_input(GLFWwindow* window, const double x_pos_in, const double y_pos_in)
// {
